...
<style>
    ...
    <tbody>
        ...
        <table>
            <thead>
                <tr>
                    <th style="background-color:#235298; text-align: center; padding: 0px;">
                        <h3 style="text-align: center;"><i class="fas fa-thumbtack"></i>  Avisos</h3>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="background-color:#b4b8bb; ">
                        <div id="avisos-container">
                            @foreach($avisos as $index => $dato)
                                <div class="tarjeta aviso @if($index >= 3) d-none @endif">
                                    <div class="tarjeta-header">
                                <strong class="fecha"><i class="fas fa-exclamation-circle"></i>  {{ $dato->fecInicio }} </strong>
                                    </div>
            ...
            <tr>
            <td style="background-color:#235298;">       
                <div style="display: flex; flex-direction: column;">
                    <div style="display: flex; align-items: center; padding: 3px;">
                        ...
                        <a href="https://www.facebook.com/UmssBolOficial/" target="new" style="font-size:13px; color:#fff; margin-left: 5px;">Facebook UMSS</a>
                    </div>
                    <div style="display: flex; align-items: center; padding: 3px;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="15" height="15">
                        ...
                        <a href="https://twitter.com/umssbolivia" target="new" style="font-size:13px; color:#fff; margin-left: 5px;">Twitter UMSS</a>
                    </div>
                    <div style="display: flex; align-items: center; padding: 3px;">
                        ...
                        <a href="https://www.youtube.com/user/CanalUmsstv" target="new" style="font-size:13px; color:#fff; margin-left: 5px;">YouTube UMSS</a>
                    </div>
                    <div style="display: flex; align-items: center; padding: 3px;">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="15" height="15">
                        ...
                        <a href="http://www.umss.edu.bo/index.php/blog/" target="new" style="font-size:13px;color:#fff; margin-left: 5px;">Blog UMSS</a>
                    </div>
                </div>
            </td>
            </tr>
