            ...
            <div class="form-row">
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="hora_inicio" name="hora_inicio" min="06:45" max="21:25" step="900"  value="{{ $reserva->horaInicio }}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-column">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="materia_hidden" name="materia" value="{{ $materia }}">
                        <select id="materia" name="materia" onchange="toggleIntervalo()" required>
                            <option value="" disabled selected hidden>----</option>
                            @foreach($materias as $idMateria => $materia)
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="hora_fin" name="hora_fin" min="06:45" max="21:45" step="900" value="{{ $horaFin }}" required>
                    </div>
                    <!-- <div class="form-group">
